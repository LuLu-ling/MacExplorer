...
public static class LogWrapper
{
    ...
    public static void Debug(Exception ex, string module, string message) => Debug(module, $"{message}: {ex}");
    ...
    private static readonly Lazy<LoggerFactoryAdapter> LoggerFactoryLazy = new(static () => new LoggerFactoryAdapter(CurrentLogger));
    public static LoggerFactoryAdapter LoggerFactory => LoggerFactoryLazy.Value;
}
